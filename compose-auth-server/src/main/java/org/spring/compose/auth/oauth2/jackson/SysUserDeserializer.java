package org.spring.compose.auth.oauth2.jackson;
...
class SysUserDeserializer extends JsonDeserializer<SysUserDetails> {
    ...
    public SysUserDetails deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        SysUserDetails result = new SysUserDetails(userId, username, password, dataScope, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities);
