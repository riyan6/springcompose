...
import org.spring.compose.auth.handler.MyAuthenticationFailureHandler;
import org.spring.compose.auth.handler.MyAuthenticationSuccessHandler;
import org.spring.compose.auth.model.SysUserDetails;
import org.spring.compose.auth.oauth2.extension.password.PasswordAuthenticationConverter;
import org.spring.compose.auth.oauth2.extension.password.PasswordAuthenticationProvider;
import org.spring.compose.auth.oauth2.jackson.SysUserMixin;
